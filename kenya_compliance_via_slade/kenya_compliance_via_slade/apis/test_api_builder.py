...
class TestApis(FrappeTestCase):
    ...
    @patch(
        "kenya_compliance_via_slade.kenya_compliance_via_slade.apis.api_builder.update_last_request_date",
        new_callable=patched_update_request_date,
    )
    @patch(
        "kenya_compliance_via_slade.kenya_compliance_via_slade.apis.api_builder.make_post_request",
